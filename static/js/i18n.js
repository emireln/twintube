...
const translations = {
  en: {
    ...
    guest_room_grace_hint: "Guest rooms stay joinable for 15 minutes after everyone leaves.",
    room_name: "Room name",
    ...
    avatar_url_optional: "Or paste image URL",
    avatar_url_ph: "https://...",
    avatar_randomize: "Randomize",
    avatar_uploaded: "Profile photo updated",
    avatar_upload_fail: "Failed to upload photo",
    avatar_upload_invalid: "Choose a JPEG, PNG, WebP, or GIF image",
    avatar_upload_too_large: "Image must be 2 MB or smaller",
    ...
    failed_send_message: "Could not send message. Check your connection.",
    ...
    confirm_make_host: "Transfer host to {name}? You will lose host controls.",
    ...
    chat_mention_hint: "Type @ to mention someone",
    chat_reaction_picker: "Add reaction",
    hype_burst: "{count} reacted {emoji} at {time}",
    notify_mention_title: "{name} mentioned you",
    notify_cowatch_title: "{name} started a watch room",
    notify_cowatch_body: "{room} — tap to join",
    notify_settings: "Notifications",
    notify_settings_desc: "Browser or desktop alerts when you're mentioned or a co-watcher starts a room",
    notify_enable: "Enable notifications",
    notify_mentions: "@mention alerts",
    notify_cowatch: "Co-watcher room alerts",
    notify_permission: "Allow notifications",
  ...
  pt: {
    ...
    drawer_room: "Sala",
    drawer_prefs: "Preferências",
    drawer_account: "Conta",
    open: "Abrir",
    copy: "Copiar",
    delete: "Excluir",
    public: "Pública",
    ...
    guest_room_grace_hint: "Salas de convidado permanecem abertas por 15 minutos depois que todos saem.",
    ...
    avatar_photo: "Foto de perfil",
    avatar_upload: "Enviar imagem",
    avatar_url_optional: "Ou cole a URL da imagem",
    avatar_url_ph: "https://...",
    avatar_randomize: "Aleatorizar",
    avatar_uploaded: "Foto de perfil atualizada",
    avatar_upload_fail: "Falha ao enviar a foto",
    avatar_upload_invalid: "Escolha uma imagem JPEG, PNG, WebP ou GIF",
    avatar_upload_too_large: "A imagem deve ter no máximo 2 MB",
    ...
    failed_send_message: "Não foi possível enviar. Verifique sua conexão.",
    ...
    confirm_make_host: "Transferir o anfitrião para {name}? Você perderá o controle de anfitrião.",
    ...
    chat_react: "Reagir",
    chat_replying_to: "Respondendo a {name}",
    chat_cancel_reply: "Cancelar resposta",
    chat_mention_hint: "Digite @ para mencionar alguém",
    chat_reaction_picker: "Adicionar reação",
    hype_burst: "{count} reagiram {emoji} em {time}",
    notify_mention_title: "{name} mencionou você",
    notify_cowatch_title: "{name} abriu uma sala",
    notify_cowatch_body: "{room} — toque para entrar",
    notify_settings: "Notificações",
    notify_settings_desc: "Alertas no navegador ou desktop quando você for mencionado ou um co-espectador abrir sala",
    notify_enable: "Ativar notificações",
    notify_mentions: "Alertas de @menção",
    notify_cowatch: "Alertas de sala de co-espectadores",
    notify_permission: "Permitir notificações",
